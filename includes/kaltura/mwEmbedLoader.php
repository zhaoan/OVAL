KALTURA_SCRIPT_NAME =  "/apis/html5lib/mwEmbed/mwEmbedLoader.php";
...
SCRIPT_LOADER_URL = 'http://cdnakmi.kaltura.org/apis/html5lib/mwEmbed/ResourceLoader.php';
mw.setConfig('Kaltura.UseManifestUrls', true );
mw.setConfig('Kaltura.ServiceUrl', 'http://www.kaltura.com' );
mw.setConfig('Kaltura.ServiceBase', '/api_v3/index.php?service=' );
mw.setConfig('Kaltura.CdnUrl', 'http://cdn.kaltura.com' );
